...
export default function CarCardPage(props) {
    ...
    announcementsService.getAnnouncments(id).then(v => { setCar(v[0]); console.log(v[0]) })
            ...
            <div className="content" id='carCardPage'>
                <div className="row">
                    <div className="leftSide">
                        <div className="navigation"><p><span><Link to='/'>Домашня сторінка</Link></span> / <span>Вживані авто</span> / {`${car.Brands.name} ${car.CarModels.name} ${car.year}`} </p></div>
                        <div className="button linkButton"><img src={Scale} alt="" />Повернутись до пошуку</div>
                        <div className="images">
                            <div className="main">
                                <img src={car.AnnouncementsPhotos[1] ? car.AnnouncementsPhotos[1].url : ''} alt="" />
                            </div>
                            <div className="list">
                        ...
                        <div className="generalSettings">
                            ...
                            <div className="stat">
                                ...
                                <div className="statValue">
                                    {`${car.Brands.name} ${car.CarModels.name} ${car.year}`}
                                </div>
                            </div>
                            <div className="stat">
                                <div className="statName">
